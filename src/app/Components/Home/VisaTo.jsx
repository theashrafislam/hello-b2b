    ...
    return (
        <div className='bg-[#202020] text-left px-12'>
            ...
            <div className='flex justify-between gap-[64px] pb-[183px]'>
                <div className='w-[50%]'>
                    <img src="/2nd.png" alt="" className='w-full h-[1001px] rounded-xl' />
                </div>
                <div className='w-[50%] text-[#D0A148]'>
                    <p className='font-medium text-[25px] mb-[36px]'>About Us</p>
                    <h3 className='text-[45px] font-bold'>From Visa to Visitation—We Handle It All.</h3>
